...
declare interface Game_Temp
{
	...
	destinationX(): number;
	destinationY(): number;
	setTouchState(target: Game_Enemy, state: string): void;
	...
	requestAnimation(targets: Array<Game_Player> | Array<Game_Enemy> | Game_Temp.prototype.RequestAnimation0, animationId: number, mirror: boolean): void;
...
declare interface Game_System
{
	...
	battleBgm(): PannableAudioSettings;
	setBattleBgm(value: any): void;
	victoryMe(): PannableAudioSettings;
...
declare interface Game_SelfSwitches
{
	...
	initialize(): void;
	clear(): void;
	value(key: Array<number>, param2: any, param3: any): boolean;
...
declare interface Game_Action
{
	...
	isValid(): boolean;
	speed(): void;
	makeTargets(): Array<Game_Enemy>;
	repeatTargets(targets: Array<Game_Enemy>): Array<Game_Enemy>;
	confusionTarget(): Game_Enemy;
	targetsForEveryone(): Game_Action.prototype.TargetsForEveryoneRet;
	targetsForOpponents(): Array<Game_Enemy>;
	targetsForFriends(): Array<Game_Actor>;
	...
	testItemEffect(target: Game_Actor, effect: ItemEffect): boolean;
	itemCnt(target: Game_Enemy): number;
	itemMrf(target: Game_Enemy): number;
	itemHit(): number;
	itemEva(target: Game_Enemy): number;
	...
	elementsMaxRate(target: Game_Enemy, elements: Array<number>): number;
	...
	applyItemEffect(target: Game_Enemy, effect: ItemEffect): void;
	itemEffectRecoverHp(target: Game_Actor, effect: ItemEffect): void;
	itemEffectRecoverMp(target: Game_Actor, effect: ItemEffect): void;
	itemEffectGainTp(target: Game_Actor, effect: any): void;
	itemEffectAddState(target: Game_Enemy, effect: ItemEffect): void;
	itemEffectAddAttackState(target: Game_Enemy, effect: ItemEffect): void;
	itemEffectAddNormalState(target: Game_Actor, effect: any): void;
	itemEffectRemoveState(target: Game_Actor, effect: any): void;
	itemEffectAddBuff(target: Game_Actor, effect: ItemEffect): void;
	...
	itemEffectGrow(target: Game_Actor, effect: ItemEffect): void;
...
declare interface Game_ActionResult
{
	...
	initialize(): void;
	clear(): void;
	addedStateObjects(): Array<BattlerStatus>;
...
declare interface Game_Battler extends Game_BattlerBase
{
	...
	setLastTarget(target: Game_Enemy): void;
	forceAction(skillId: any, targetIndex: any): void;
	useItem(item: Object): void;
...
declare interface Game_Party extends Game_Unit
{
	...
	charactersForSavefile(): Array<Array<string>>;
	facesForSavefile(): Array<Array<string>>;
	partyAbility(abilityId: number): boolean;
...
declare interface Game_Interpreter
{
	...
	command101(params: Array<string>): boolean;
	...
	command121(params: Array<number>): boolean;
	command122(params: Array<number>): boolean;
	...
	command123(params: Array<string>): boolean;
	command124(params: any): boolean;
	command125(params: Array<number>): boolean;
	command126(params: Array<number>): boolean;
	...
	command201(params: Array<number>): boolean;
	...
	command212(params: Array<number>): boolean;
	...
	command301(params: Array<number>): boolean;
	command601(): boolean;
	command602(): boolean;
	command603(): boolean;
	command302(params: Array<number>): boolean;
